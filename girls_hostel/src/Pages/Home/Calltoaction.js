                ...
                <div className='action-form'>
                    ...
                    <div className='action text-center'>
                        <div className='action-card'>
                            ...
                            <p className='p-action'>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor.</p>
                            <h2>Rashi Sharma</h2>
                        </div>
                    </div>
                </div>
